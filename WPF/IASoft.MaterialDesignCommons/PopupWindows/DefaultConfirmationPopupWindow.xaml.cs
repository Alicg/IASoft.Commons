...
namespace IASoft.MaterialDesignCommons.PopupWindows
{
    ...
    /// </summary>
    public partial class DefaultConfirmationPopupWindow
    {
        public DefaultConfirmationPopupWindow()
        {
        ...
        private void DefaultConfirmationPopupWindow_OnKeyDown(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.Enter)
            {
